...
function checkLocalStorageSignin() {
    if (grabLocalStorageSignIn === "[]" || grabLocalStorageSignIn === null) {
        ...
        user = "".concat(data.title, " ").concat(data.firstname, " ").concat(data.lastname);
        address = "".concat(data.address, " ").concat(data.city, " ").concat(data.state, " ").concat(data.country);
        document.querySelector("#DBuser").innerHTML = user;
        document.querySelector("#DBaddress").innerHTML = address;
        document.querySelector("#DBemail").innerHTML = "".concat(data.email, " ");
        document.querySelector("#DBphone").innerHTML = "".concat(data.phone, " ");
        document.querySelector("#DBpassword").innerHTML = "".concat(data.password, " ");
    }
}
...
function inputValidation(input) {
    if (input.value === "" ||
        ...
        input.value === "Please Select") {
        errorMessage(input, "Enter ".concat(input.name.charAt(0).toUpperCase() + input.name.substring(1)));
        submit = false;
    }
    else if (input.value) {
        if (input.name === "title") {
...
var flightObjects = [
    {
        ...
        stopAirportCode: [],
        economy: Math.floor(measureKm(airportObjects[0].cooridates.laltitude, airportObjects[0].cooridates.longitude, airportObjects[1].cooridates.laltitude, airportObjects[1].cooridates.longitude) * economicPrice),
        premium: Math.floor(measureKm(airportObjects[0].cooridates.laltitude, airportObjects[0].cooridates.longitude, airportObjects[1].cooridates.laltitude, airportObjects[1].cooridates.longitude) * premiumPrice),
        business: Math.floor(measureKm(airportObjects[0].cooridates.laltitude, airportObjects[0].cooridates.longitude, airportObjects[1].cooridates.laltitude, airportObjects[1].cooridates.longitude) * businessPrice),
    },
    {
        flightId: 65476,
        flightNumber: 362,
        ...
        economy: Math.floor(measureKm(airportObjects[0].cooridates.laltitude, airportObjects[0].cooridates.longitude, airportObjects[2].cooridates.laltitude, airportObjects[2].cooridates.longitude) * economicPrice),
        premium: Math.floor(measureKm(airportObjects[0].cooridates.laltitude, airportObjects[0].cooridates.longitude, airportObjects[2].cooridates.laltitude, airportObjects[2].cooridates.longitude) * premiumPrice),
        business: Math.floor(measureKm(airportObjects[0].cooridates.laltitude, airportObjects[0].cooridates.longitude, airportObjects[2].cooridates.laltitude, airportObjects[2].cooridates.longitude) * businessPrice),
    },
    {
        flightId: 65476,
        flightNumber: 362,
    ...
    },
    {
        ...
        stopAirportCode: [],
        economy: Math.floor(measureKm(airportObjects[1].cooridates.laltitude, airportObjects[1].cooridates.longitude, airportObjects[0].cooridates.laltitude, airportObjects[0].cooridates.longitude) * economicPrice),
        premium: Math.floor(measureKm(airportObjects[1].cooridates.laltitude, airportObjects[1].cooridates.longitude, airportObjects[0].cooridates.laltitude, airportObjects[0].cooridates.longitude) * premiumPrice),
        business: Math.floor(measureKm(airportObjects[1].cooridates.laltitude, airportObjects[1].cooridates.longitude, airportObjects[0].cooridates.laltitude, airportObjects[0].cooridates.longitude) * businessPrice),
    },
    {
        flightId: 45235,
        flightNumber: 232,
        ...
        stopAirportCode: [],
        economy: Math.floor(measureKm(airportObjects[1].cooridates.laltitude, airportObjects[1].cooridates.longitude, airportObjects[2].cooridates.laltitude, airportObjects[2].cooridates.longitude) * economicPrice),
        premium: Math.floor(measureKm(airportObjects[1].cooridates.laltitude, airportObjects[1].cooridates.longitude, airportObjects[2].cooridates.laltitude, airportObjects[2].cooridates.longitude) * premiumPrice),
        business: Math.floor(measureKm(airportObjects[1].cooridates.laltitude, airportObjects[1].cooridates.longitude, airportObjects[2].cooridates.laltitude, airportObjects[2].cooridates.longitude) * businessPrice),
    },
    {
        flightId: 63718,
        flightNumber: 452,
        ...
        economy: Math.floor(measureKm(airportObjects[2].cooridates.laltitude, airportObjects[2].cooridates.longitude, airportObjects[0].cooridates.laltitude, airportObjects[0].cooridates.longitude) * economicPrice),
        premium: Math.floor(measureKm(airportObjects[2].cooridates.laltitude, airportObjects[2].cooridates.longitude, airportObjects[0].cooridates.laltitude, airportObjects[0].cooridates.longitude) * premiumPrice),
        business: Math.floor(measureKm(airportObjects[2].cooridates.laltitude, airportObjects[2].cooridates.longitude, airportObjects[0].cooridates.laltitude, airportObjects[0].cooridates.longitude) * businessPrice),
    },
    {
        flightId: 25143,
        flightNumber: 634,
        ...
        stopAirportCode: [],
        economy: Math.floor(measureKm(airportObjects[2].cooridates.laltitude, airportObjects[2].cooridates.longitude, airportObjects[1].cooridates.laltitude, airportObjects[1].cooridates.longitude) * economicPrice),
        premium: Math.floor(measureKm(airportObjects[2].cooridates.laltitude, airportObjects[2].cooridates.longitude, airportObjects[1].cooridates.laltitude, airportObjects[1].cooridates.longitude) * premiumPrice),
        business: Math.floor(measureKm(airportObjects[2].cooridates.laltitude, airportObjects[2].cooridates.longitude, airportObjects[1].cooridates.laltitude, airportObjects[1].cooridates.longitude) * businessPrice),
    },
];
...
function reservationFlights() {
    ...
    else if ((from.value !== "Please Select" || from.value !== "PLEASE SELECT") &&
        (to.value !== "Please Select" || to.value !== "PLEASE SELECT")) {
...
////////////////////////// Login SignIn Code ////////////////////////////////
var validation = false, registration = [], registerObject = {};
function SignInSubmission() {
    var signInFormSubmission = document.getElementById("login");
    signInFormSubmission.addEventListener("submit", function (e) {
        e.preventDefault();
...
function generateId() {
    var length = 8, charset = "0123456789", retVal = "";
    for (var i = 0, n = charset.length; i < length; ++i) {
        retVal += charset.charAt(Math.floor(Math.random() * n));
    }
    return retVal;
...
function SignUpSubmission() {
    ...
    signUpFormSubmission.addEventListener("submit", function (e) {
        var _a;
        e.preventDefault();
        var getRegistrations = grabLocalStorageRegistration();
        ...
        for (var i = 0; i < inputs.length; i++) {
            ...
            if (submitForm) {
                validation = true;
                Object.assign(registerObject, (_a = {}, _a[inputs[i].name] = inputs[i].value, _a));
            }
            else {
                validation = false;
                break;
